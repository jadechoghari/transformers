...
from transformers import DINOv2Config, DINOv2ForImageClassification, DINOv2ImageProcessor, DINOv2Model
...
def convert_dinov2_checkpoint(model_name, pytorch_dump_folder_path, base_model=True):
    ...
    # Check outputs on an image, prepared by DINOv2ImageProcessor
    image_processor = DINOv2ImageProcessor()
